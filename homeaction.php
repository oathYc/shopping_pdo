...
if(isset($_POST["categoryhome"])){
	...
	if($run_query->rowCount() > 0){
		foreach($run_query as $row){
            ...
            $turn = isset($_SESSION['turn'])?$_SESSION['turn']:1;
            
            
			echo "
					
                    
                               <li class='categoryhome' cid='$cid' turn='$turn'><a href='store.php'>$cat_name</a></li>
                                ...
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h3 class='product-name'><a href='product.php?p=$pro_id'>$pro_title</a></h3>
                                            <h4 class='product-price'>$pro_price<del class='product-old-price'>".($pro_price*1.1)."</del></h4>
									</div></a>
								</div>
			...
			echo "
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' href='#' tabindex='0' class='add-to-cart-btn'><i class='fa fa-shopping-cart'></i> 添加购物车</button>
									</div>
								</div>
							</div>
			";
