				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">$'.$row['product_price'].'<del class="product-old-price">$'.$row['product_price']*1.1.'</del></h3>
								<span class="product-available">现货</span>
							</div>
							<p>'.$row['product_keywords'].'</p>
							...
							<div class="add-to-cart">
								...
								<button class="add-to-cart-btn" pid="'.$row['product_id'].'"  id="product" ><i class="fa fa-shopping-cart"></i> 购物车</button>
								<button class="add-to-cart-btn" onclick="buyPro()" pid="'.$row['product_id'].'"  id="product_buy" ><i class="fa fa-shopping-cart"></i> 购买</button>
                                </div>
					...
					<div class="col-md-12">
						<div id="product-tab">
							<!-- product tab nav -->
							<ul class="tab-nav">
								<li class="active"><a data-toggle="tab" href="#tab2">详细信息</a></li>
								<li><a data-toggle="tab" href="#tab3">评价 (3)</a></li>
							</ul>
							<!-- /product tab nav -->
										...
										<div class="col-md-3 mainn">
											<div id="review-form">
												<form class="review-form">
													...
													<textarea class="input" placeholder="评价"></textarea>
