				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>笔记本电脑<br></h3>
								<a href="product.php?p=78" class="cta-btn">立即购买 <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>配件</h3>
								<a href="product.php?p=72" class="cta-btn">立即购买 <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								<h3>相机</h3>
								<a href="product.php?p=79" class="cta-btn">立即购买<i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">本周热门交易</h2>
							<p>新系列最多可享受五折优惠</p>
							<a class="primary-btn cta-btn" href="store.php">立即购买</a>
						</div>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-5">
							<div id="get_product_home5">

							</div>

							<div id="get_product_home6">
