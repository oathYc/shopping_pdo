$(document).ready(function(){
    ...
    function producthome2(){
		$.ajax({
			url	:	"homeaction.php",
			method:	"POST",
			data	:	{getProducthome:2},
			success	:	function(data){
				$("#get_product_home2").html(data);
			}
		});
	}
    function producthome3(){
		$.ajax({
			url	:	"homeaction.php",
			method:	"POST",
			data	:	{getProducthome:3},
			success	:	function(data){
				$("#get_product_home3").html(data);
			}
		});
	}
    function producthome4(){
		$.ajax({
			url	:	"homeaction.php",
			method:	"POST",
			data	:	{getProducthome:4},
			success	:	function(data){
				$("#get_product_home4").html(data);
			}
		});
	}
    function producthome5(){
		$.ajax({
			url	:	"homeaction.php",
			method:	"POST",
			data	:	{getProducthome:5},
			success	:	function(data){
				$("#get_product_home5").html(data);
			}
		});
	}
    function producthome6(){
		$.ajax({
			url	:	"homeaction.php",
			method:	"POST",
			data	:	{getProducthome:6},
			success	:	function(data){
				$("#get_product_home6").html(data);
			}
		});
	}
