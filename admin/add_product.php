...
<body>
	...
	<h1><span class="glyphicon glyphicon-tag"></span> 商品 / 添加商品  </h1></div><br>
	<div class="panel-body" style="background-color:#E6EEEE;">
        ...
        <p>名称</p>
        <input class="input-lg thumbnail form-control" type="text" name="product_name" id="商品名称" autofocus style="width:100%" placeholder="Product Name" required>
<p>描述</p>
<textarea class="thumbnail form-control" name="details" id="details" style="width:100%; height:100px" placeholder="商品详情" required></textarea>
<p>添加图片</p>
...
<h3>分类</h3>
<p>商品类型</p>
<input type="number" name="product_type" id="product_type" class="form-control" placeholder="1 数码产品,2 女装,3 男装">
<br>
<p>供应商/品牌</p>
